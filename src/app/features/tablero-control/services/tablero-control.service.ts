...
export class TableroControlService {
  ...
  private getDatosMock(): ResumenTablero {
    ...
    const proyectosEnCurso: ProyectoEnCurso[] = [
      ...
      { id: 6,  proyecto: 'Diseño Puente Vehicular Ruta 5', empresa: 'Ayni S.A.C.', responsable: 'Carlos López',    etapa: 'Entrega Final',          fechas: '01/02 - 28/02', estado: 'Completado',  mes: 'Feb', fechaCreacion: new Date('2026-02-01'),  gastoTotal: 28000 },
      ...
      { id: 14, proyecto: 'Pavimentación Acceso Industrial km 12', empresa: 'Ayni S.A.C.', responsable: 'Hugo Ríos',       etapa: 'Carpeta Asfáltica',      fechas: '04/03 - 29/03', estado: 'Completado',  mes: 'Mar', fechaCreacion: new Date('2026-03-04'),  gastoTotal: 48000 },
      ...
      { id: 19, proyecto: 'Diseño Estructural Galpón Industrial', empresa: 'Ayni S.A.C.', responsable: 'Carlos López',    etapa: 'Modelado SAP2000',       fechas: '15/03 - 20/05', estado: 'Pendiente',   mes: 'Mar', fechaCreacion: new Date('2026-03-15'),  gastoTotal: 18000 },

      // ── ABRIL (Finalizados=2, Activos=2) ──────────────────────────────────
      { id: 20, proyecto: 'Rehabilitación Puente Peatonal Norte', empresa: 'Ayni S.A.C.', responsable: 'Hugo Ríos',       etapa: 'Entrega Final',          fechas: '01/04 - 28/04', estado: 'Completado',  mes: 'Abr', fechaCreacion: new Date('2026-04-01'),  gastoTotal: 31000 },
      ...
      { id: 26, proyecto: 'Muro de Contención Zona Alta', empresa: 'Ayni S.A.C.', responsable: 'Jorge Castillo',  etapa: 'Vaciado Final',          fechas: '06/05 - 31/05', estado: 'Completado',  mes: 'May', fechaCreacion: new Date('2026-05-06'),  gastoTotal: 39000 },
      ...
      { id: 30, proyecto: 'Reparación Estructura Metálica Nave 4', empresa: 'Ayni S.A.C.', responsable: 'Carlos López',    etapa: 'Soldadura Final',        fechas: '01/06 - 27/06', estado: 'Completado',  mes: 'Jun', fechaCreacion: new Date('2026-06-01'),  gastoTotal: 27000 },
      ...
      { id: 32, proyecto: 'Pavimentación Patio Maniobras Logística', empresa: 'Ayni S.A.C.', responsable: 'Hugo Ríos',       etapa: 'Subbase Granular',       fechas: '05/06 - 30/08', estado: 'En Proceso',  mes: 'Jun', fechaCreacion: new Date('2026-06-05'),  gastoTotal: 53000 },
      ...
      { id: 39, proyecto: 'Reforzamiento Pilares Puente Industrial', empresa: 'Ayni S.A.C.', responsable: 'Carlos López',    etapa: 'Entrega Final',          fechas: '05/08 - 31/08', estado: 'Completado',  mes: 'Ago', fechaCreacion: new Date('2026-08-05'),  gastoTotal: 44000 },
      ...
      { id: 49, proyecto: 'Diseño Nave Logística Ampliación', empresa: 'Ayni S.A.C.', responsable: 'María García',    etapa: 'Anteproyecto',           fechas: '06/10 - 30/01', estado: 'En Proceso',  mes: 'Oct', fechaCreacion: new Date('2026-10-06'),  gastoTotal: 43000 },
      ...
      { id: 53, proyecto: 'Diseño Muelle Descarga Materia Prima', empresa: 'Ayni S.A.C.', responsable: 'Luis Torres',     etapa: 'Ingeniería Básica',      fechas: '10/11 - 30/03', estado: 'Pendiente',   mes: 'Nov', fechaCreacion: new Date('2026-11-10'),  gastoTotal: 31000 },
