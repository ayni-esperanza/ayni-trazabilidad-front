...
export class TableroControlService {
  ...
  private getDatosMock(): ResumenTablero {
    ...
    const proyectosEnCurso: ProyectoEnCurso[] = [
      ...
      { id: 1,  proyecto: 'Planta Tratamiento Agua Residual',     responsable: 'Luis Torres',     etapa: 'Entrega Final',          fechas: '03/01 - 28/01', estado: 'Completado',  mes: 'Ene', fechaCreacion: new Date('2026-01-03'),  gastoTotal: 52000 },
      { id: 2,  proyecto: 'Sistema Transportador de Carga',        responsable: 'Rosa Díaz',       etapa: 'Pruebas y Validación',   fechas: '10/01 - 31/01', estado: 'Completado',  mes: 'Ene', fechaCreacion: new Date('2026-01-10'),  gastoTotal: 38000 },
      { id: 3,  proyecto: 'Línea Producción Textil A',             responsable: 'Juan Pérez',      etapa: 'Ingeniería',             fechas: '15/01 - 30/03', estado: 'En Proceso',  mes: 'Ene', fechaCreacion: new Date('2026-01-15'),  gastoTotal: 45000 },
      { id: 4,  proyecto: 'Sistema Ventilación Industrial',         responsable: 'María García',    etapa: 'Instalación',            fechas: '20/01 - 15/04', estado: 'En Proceso',  mes: 'Ene', fechaCreacion: new Date('2026-01-20'),  gastoTotal: 32000 },
      { id: 5,  proyecto: 'Automatización Almacén Central',         responsable: 'Pedro Sánchez',   etapa: 'Diseño',                 fechas: '22/01 - 20/03', estado: 'Pendiente',   mes: 'Ene', fechaCreacion: new Date('2026-01-22'),  gastoTotal: 21000 },

      // ── FEBRERO (Finalizados=3, Activos=4) ────────────────────────────────
      { id: 6,  proyecto: 'Diseño Puente Vehicular Ruta 5',        responsable: 'Carlos López',    etapa: 'Entrega Final',          fechas: '01/02 - 28/02', estado: 'Completado',  mes: 'Feb', fechaCreacion: new Date('2026-02-01'),  gastoTotal: 28000 },
      { id: 7,  proyecto: 'Rehabilitación Red Eléctrica Sur',       responsable: 'Elena Vargas',    etapa: 'Inspección Final',       fechas: '03/02 - 25/02', estado: 'Completado',  mes: 'Feb', fechaCreacion: new Date('2026-02-03'),  gastoTotal: 19500 },
      { id: 8,  proyecto: 'Cimentaciones Edificio Corporativo B',   responsable: 'Hugo Ríos',       etapa: 'Cierre Técnico',         fechas: '05/02 - 27/02', estado: 'Completado',  mes: 'Feb', fechaCreacion: new Date('2026-02-05'),  gastoTotal: 67000 },
      { id: 9,  proyecto: 'Mantenimiento Maquinaria Pesada',         responsable: 'Ana Martínez',    etapa: 'Diagnóstico',            fechas: '05/02 - 20/03', estado: 'En Proceso',  mes: 'Feb', fechaCreacion: new Date('2026-02-05'),  gastoTotal: 15500 },
      { id: 10, proyecto: 'Sistema Automatización Línea 2',          responsable: 'Pedro Sánchez',   etapa: 'Programación PLC',       fechas: '10/02 - 30/04', estado: 'En Proceso',  mes: 'Feb', fechaCreacion: new Date('2026-02-10'),  gastoTotal: 22000 },
      { id: 11, proyecto: 'Instalación Paneles Solares Planta A',    responsable: 'Sofía Mendoza',   etapa: 'Montaje',                fechas: '12/02 - 15/04', estado: 'En Proceso',  mes: 'Feb', fechaCreacion: new Date('2026-02-12'),  gastoTotal: 41000 },
      { id: 12, proyecto: 'Ampliación Red Hídrica Zona Norte',       responsable: 'Jorge Castillo',  etapa: 'Excavación',             fechas: '15/02 - 30/05', estado: 'Pendiente',   mes: 'Feb', fechaCreacion: new Date('2026-02-15'),  gastoTotal: 33000 },

      // ── MARZO (Finalizados=4, Activos=3) ──────────────────────────────────
      { id: 13, proyecto: 'Modernización Subestación Eléctrica',     responsable: 'Elena Vargas',    etapa: 'Comisionamiento',        fechas: '02/03 - 28/03', estado: 'Completado',  mes: 'Mar', fechaCreacion: new Date('2026-03-02'),  gastoTotal: 55000 },
      { id: 14, proyecto: 'Pavimentación Acceso Industrial km 12',   responsable: 'Hugo Ríos',       etapa: 'Carpeta Asfáltica',      fechas: '04/03 - 29/03', estado: 'Completado',  mes: 'Mar', fechaCreacion: new Date('2026-03-04'),  gastoTotal: 48000 },
      { id: 15, proyecto: 'Instalación Compresores Alta Presión',     responsable: 'Luis Torres',     etapa: 'Pruebas Hidráulicas',    fechas: '05/03 - 31/03', estado: 'Completado',  mes: 'Mar', fechaCreacion: new Date('2026-03-05'),  gastoTotal: 37000 },
      { id: 16, proyecto: 'Remodelación Almacén Logístico Norte',     responsable: 'Rosa Díaz',       etapa: 'Pintura y Acabados',     fechas: '08/03 - 30/03', estado: 'Completado',  mes: 'Mar', fechaCreacion: new Date('2026-03-08'),  gastoTotal: 24000 },
      { id: 17, proyecto: 'Red Contra Incendios Edificio C',          responsable: 'Sofía Mendoza',   etapa: 'Instalación Tuberías',   fechas: '10/03 - 15/05', estado: 'En Proceso',  mes: 'Mar', fechaCreacion: new Date('2026-03-10'),  gastoTotal: 29000 },
      { id: 18, proyecto: 'Sistema SCADA Planta Minera',              responsable: 'Juan Pérez',      etapa: 'Configuración HMI',      fechas: '12/03 - 30/06', estado: 'En Proceso',  mes: 'Mar', fechaCreacion: new Date('2026-03-12'),  gastoTotal: 63000 },
      { id: 19, proyecto: 'Diseño Estructural Galpón Industrial',     responsable: 'Carlos López',    etapa: 'Modelado SAP2000',       fechas: '15/03 - 20/05', estado: 'Pendiente',   mes: 'Mar', fechaCreacion: new Date('2026-03-15'),  gastoTotal: 18000 },

      // ── ABRIL (Finalizados=2, Activos=2) ──────────────────────────────────
      { id: 20, proyecto: 'Rehabilitación Puente Peatonal Norte',     responsable: 'Hugo Ríos',       etapa: 'Entrega Final',          fechas: '01/04 - 28/04', estado: 'Completado',  mes: 'Abr', fechaCreacion: new Date('2026-04-01'),  gastoTotal: 31000 },
      { id: 21, proyecto: 'Línea Producción Textil B',                responsable: 'María García',    etapa: 'Pruebas de Arranque',    fechas: '03/04 - 30/04', estado: 'Completado',  mes: 'Abr', fechaCreacion: new Date('2026-04-03'),  gastoTotal: 26000 },
      { id: 22, proyecto: 'Expansión Planta Farmacéutica',            responsable: 'Ana Martínez',    etapa: 'Validación GMP',         fechas: '05/04 - 30/06', estado: 'En Proceso',  mes: 'Abr', fechaCreacion: new Date('2026-04-05'),  gastoTotal: 88000 },
      { id: 23, proyecto: 'Sistema Gestión Energética Fábrica',       responsable: 'Pedro Sánchez',   etapa: 'Implementación',         fechas: '10/04 - 30/07', estado: 'Pendiente',   mes: 'Abr', fechaCreacion: new Date('2026-04-10'),  gastoTotal: 47000 },

      // ── MAYO (Finalizados=3, Activos=3) ───────────────────────────────────
      { id: 24, proyecto: 'Instalación Calderas Industriales',        responsable: 'Luis Torres',     etapa: 'Puesta en Marcha',       fechas: '02/05 - 30/05', estado: 'Completado',  mes: 'May', fechaCreacion: new Date('2026-05-02'),  gastoTotal: 42000 },
      { id: 25, proyecto: 'Mejora Red Fibra Óptica Planta',           responsable: 'Elena Vargas',    etapa: 'Certificación',          fechas: '04/05 - 29/05', estado: 'Completado',  mes: 'May', fechaCreacion: new Date('2026-05-04'),  gastoTotal: 15000 },
      { id: 26, proyecto: 'Muro de Contención Zona Alta',             responsable: 'Jorge Castillo',  etapa: 'Vaciado Final',          fechas: '06/05 - 31/05', estado: 'Completado',  mes: 'May', fechaCreacion: new Date('2026-05-06'),  gastoTotal: 39000 },
      { id: 27, proyecto: 'HVAC Edificio Administrativo',             responsable: 'Rosa Díaz',       etapa: 'Balanceo de Caudales',   fechas: '08/05 - 30/07', estado: 'En Proceso',  mes: 'May', fechaCreacion: new Date('2026-05-08'),  gastoTotal: 34000 },
      { id: 28, proyecto: 'Planta Potabilizadora Módulo 3',           responsable: 'Sofía Mendoza',   etapa: 'Montaje Filtros',        fechas: '10/05 - 30/08', estado: 'En Proceso',  mes: 'May', fechaCreacion: new Date('2026-05-10'),  gastoTotal: 72000 },
      { id: 29, proyecto: 'Diseño Subestación Distribución 34.5kV',   responsable: 'Juan Pérez',      etapa: 'Ingeniería Básica',      fechas: '12/05 - 30/09', estado: 'Pendiente',   mes: 'May', fechaCreacion: new Date('2026-05-12'),  gastoTotal: 25000 },

      // ── JUNIO (Finalizados=2, Activos=2) ──────────────────────────────────
      { id: 30, proyecto: 'Reparación Estructura Metálica Nave 4',    responsable: 'Carlos López',    etapa: 'Soldadura Final',        fechas: '01/06 - 27/06', estado: 'Completado',  mes: 'Jun', fechaCreacion: new Date('2026-06-01'),  gastoTotal: 27000 },
      { id: 31, proyecto: 'Actualización PLC Línea Bottling',         responsable: 'Ana Martínez',    etapa: 'Validación FAT',         fechas: '03/06 - 30/06', estado: 'Completado',  mes: 'Jun', fechaCreacion: new Date('2026-06-03'),  gastoTotal: 19000 },
      { id: 32, proyecto: 'Pavimentación Patio Maniobras Logística',  responsable: 'Hugo Ríos',       etapa: 'Subbase Granular',       fechas: '05/06 - 30/08', estado: 'En Proceso',  mes: 'Jun', fechaCreacion: new Date('2026-06-05'),  gastoTotal: 53000 },
      { id: 33, proyecto: 'Sistema Bombeo Contraincendios Zona B',    responsable: 'Luis Torres',     etapa: 'Prueba Hidrostática',    fechas: '10/06 - 30/09', estado: 'Pendiente',   mes: 'Jun', fechaCreacion: new Date('2026-06-10'),  gastoTotal: 31000 },

      // ── JULIO (Finalizados=2, Activos=2) ──────────────────────────────────
      { id: 34, proyecto: 'Aislamiento Térmico Tuberías Vapor',       responsable: 'Elena Vargas',    etapa: 'Entrega Final',          fechas: '01/07 - 30/07', estado: 'Completado',  mes: 'Jul', fechaCreacion: new Date('2026-07-01'),  gastoTotal: 22000 },
      { id: 35, proyecto: 'Instalación Grúa Puente 20T',              responsable: 'Jorge Castillo',  etapa: 'Pruebas de Carga',       fechas: '05/07 - 31/07', estado: 'Completado',  mes: 'Jul', fechaCreacion: new Date('2026-07-05'),  gastoTotal: 46000 },
      { id: 36, proyecto: 'Ampliación Laboratorio Calidad',           responsable: 'Sofía Mendoza',   etapa: 'Acabados Interiores',    fechas: '08/07 - 30/09', estado: 'En Proceso',  mes: 'Jul', fechaCreacion: new Date('2026-07-08'),  gastoTotal: 38000 },
      { id: 37, proyecto: 'Reubicación Línea Producción Láctea',      responsable: 'María García',    etapa: 'Ingeniería de Detalle',  fechas: '10/07 - 30/10', estado: 'Pendiente',   mes: 'Jul', fechaCreacion: new Date('2026-07-10'),  gastoTotal: 29000 },

      // ── AGOSTO (Finalizados=2, Activos=2) ─────────────────────────────────
      { id: 38, proyecto: 'Sistema Monitoreo Ambiental Planta',       responsable: 'Pedro Sánchez',   etapa: 'Comisionamiento',        fechas: '03/08 - 29/08', estado: 'Completado',  mes: 'Ago', fechaCreacion: new Date('2026-08-03'),  gastoTotal: 17000 },
      { id: 39, proyecto: 'Reforzamiento Pilares Puente Industrial',  responsable: 'Carlos López',    etapa: 'Entrega Final',          fechas: '05/08 - 31/08', estado: 'Completado',  mes: 'Ago', fechaCreacion: new Date('2026-08-05'),  gastoTotal: 44000 },
      { id: 40, proyecto: 'Diseño Red Distribución Gas Natural',      responsable: 'Juan Pérez',      etapa: 'Ingeniería Básica',      fechas: '08/08 - 30/11', estado: 'En Proceso',  mes: 'Ago', fechaCreacion: new Date('2026-08-08'),  gastoTotal: 35000 },
      { id: 41, proyecto: 'Automatización Envasado Bebidas',          responsable: 'Ana Martínez',    etapa: 'Programación Robots',    fechas: '12/08 - 30/11', estado: 'Pendiente',   mes: 'Ago', fechaCreacion: new Date('2026-08-12'),  gastoTotal: 58000 },

      // ── SEPTIEMBRE (Finalizados=3, Activos=2) ────────────────────────────
      { id: 42, proyecto: 'Impermeabilización Techo Almacén Sur',     responsable: 'Rosa Díaz',       etapa: 'Entrega Final',          fechas: '01/09 - 26/09', estado: 'Completado',  mes: 'Sep', fechaCreacion: new Date('2026-09-01'),  gastoTotal: 12000 },
      { id: 43, proyecto: 'Instalación Compresor Atlas Copco 100HP',  responsable: 'Luis Torres',     etapa: 'Prueba de Operación',    fechas: '03/09 - 29/09', estado: 'Completado',  mes: 'Sep', fechaCreacion: new Date('2026-09-03'),  gastoTotal: 38000 },
      { id: 44, proyecto: 'Estudio Impacto Ambiental Sector 3',       responsable: 'Elena Vargas',    etapa: 'Informe Final',          fechas: '05/09 - 30/09', estado: 'Completado',  mes: 'Sep', fechaCreacion: new Date('2026-09-05'),  gastoTotal: 21000 },
      { id: 45, proyecto: 'Ampliación Planta de Empaques',            responsable: 'Hugo Ríos',       etapa: 'Estructura Metálica',    fechas: '08/09 - 30/11', estado: 'En Proceso',  mes: 'Sep', fechaCreacion: new Date('2026-09-08'),  gastoTotal: 74000 },
      { id: 46, proyecto: 'Sistema Control Acceso Planta Principal',  responsable: 'Jorge Castillo',  etapa: 'Cableado Estructurado',  fechas: '10/09 - 30/11', estado: 'Pendiente',   mes: 'Sep', fechaCreacion: new Date('2026-09-10'),  gastoTotal: 14000 },

      // ── OCTUBRE (Finalizados=2, Activos=2) ───────────────────────────────
      { id: 47, proyecto: 'Pintura Epóxica Piso Nave Producción',     responsable: 'Sofía Mendoza',   etapa: 'Entrega Final',          fechas: '01/10 - 25/10', estado: 'Completado',  mes: 'Oct', fechaCreacion: new Date('2026-10-01'),  gastoTotal: 9500  },
      { id: 48, proyecto: 'Desmontaje Línea Obsoleta Zona C',         responsable: 'Pedro Sánchez',   etapa: 'Limpieza y Cierre',      fechas: '03/10 - 28/10', estado: 'Completado',  mes: 'Oct', fechaCreacion: new Date('2026-10-03'),  gastoTotal: 11000 },
      { id: 49, proyecto: 'Diseño Nave Logística Ampliación',         responsable: 'María García',    etapa: 'Anteproyecto',           fechas: '06/10 - 30/01', estado: 'En Proceso',  mes: 'Oct', fechaCreacion: new Date('2026-10-06'),  gastoTotal: 43000 },
      { id: 50, proyecto: 'Instalación Bomba Centrífuga 350m³/h',     responsable: 'Juan Pérez',      etapa: 'Montaje Mecánico',       fechas: '08/10 - 28/02', estado: 'Pendiente',   mes: 'Oct', fechaCreacion: new Date('2026-10-08'),  gastoTotal: 26000 },

      // ── NOVIEMBRE (Finalizados=1, Activos=2) ─────────────────────────────
      { id: 51, proyecto: 'Actualización Firewall Industrial OT',     responsable: 'Carlos López',    etapa: 'Entrega Final',          fechas: '03/11 - 28/11', estado: 'Completado',  mes: 'Nov', fechaCreacion: new Date('2026-11-03'),  gastoTotal: 16000 },
      { id: 52, proyecto: 'Sistema Riego Tecnificado Area Verde',     responsable: 'Rosa Díaz',       etapa: 'Tendido de Tuberías',    fechas: '05/11 - 28/02', estado: 'En Proceso',  mes: 'Nov', fechaCreacion: new Date('2026-11-05'),  gastoTotal: 8500  },
      { id: 53, proyecto: 'Diseño Muelle Descarga Materia Prima',     responsable: 'Luis Torres',     etapa: 'Ingeniería Básica',      fechas: '10/11 - 30/03', estado: 'Pendiente',   mes: 'Nov', fechaCreacion: new Date('2026-11-10'),  gastoTotal: 31000 },

      // ── DICIEMBRE (Finalizados=0, Activos=2) ─────────────────────────────
      { id: 54, proyecto: 'Iluminación LED Planta de Proceso',        responsable: 'Elena Vargas',    etapa: 'Montaje Luminarias',     fechas: '01/12 - 28/02', estado: 'En Proceso',  mes: 'Dic', fechaCreacion: new Date('2026-12-01'),  gastoTotal: 19000 },
      { id: 55, proyecto: 'Evaluación Estructural Torre Enfriamiento', responsable: 'Hugo Ríos',       etapa: 'Inspección Visual',      fechas: '05/12 - 15/03', estado: 'Pendiente',   mes: 'Dic', fechaCreacion: new Date('2026-12-05'),  gastoTotal: 12000 },
    ];
